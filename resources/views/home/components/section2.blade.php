<section class="py-[10vh]">
    ...
    <div class="flex xl:flex-row flex-col items-center justify-around py-[5vh] mb-[10vh]">
        ...
        <img src={{ asset('images/geekbank.png') }} alt="" class="xl:w-[40vw] w-[80vw] xl:mt-0 mt-8  rounded-xl border-4 hover:scale-105 duration-300 transition-all animated-border">
    </div>
    ...
    <div class="flex xl:flex-row-reverse flex-col items-center justify-around py-[5vh]">
        ...
        <img src="{{ asset('images/casaguide.png') }}" alt="" class="xl:w-[40vw] w-[80vw] xl:mt-0 mt-8 rounded-xl border-4 hover:scale-105 duration-300 transition-all animated-border">
    </div>
